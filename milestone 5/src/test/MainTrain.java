 ...
 * <p>
 * This class contains unit-like tests to verify the functionality of the
 * {@link RequestParser}
 * and the {@link MyHTTPServer}. It simulates client requests and asserts
...
public class MainTrain { // RequestParser
    ...
    /**
     * Tests the RequestParser logic in isolation.
     * <p>
     * Creates a dummy HTTP request string, feeds it to the parser, and checks if
     * all fields (Command, URI, Parameters, Content) are extracted correctly.
     * </p>
     */
    ...
    /**
     * Integration test for the MyHTTPServer.
     * <p>
     * 1. Starts the server.
     * 2. Registers Servlets.
     * 3. Sends real socket requests to the server.
     * 4. Verifies responses and thread management.
     * </p>
     */
    public static void testServer() throws Exception {
        ...
        // ------------------------------------------------------------------
        String metaReq = "POST /echo HTTP/1.1\r\n" +
                "Host: localhost\r\n" +
                "Content-Length: 5\r\n" + // intentionally wrong
                "\r\n" +
                "filename=\"file.txt\"\r\n" +
        ...
        String plainReq = "POST /echo HTTP/1.1\r\n" +
                "Host: localhost\r\n" +
